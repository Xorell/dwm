...
static const Rule rules[] = {
    ...
    */
    ...
    { "Microsoft Teams", NULL,         NULL,         1 << 8,      0,           0,          0,        -1 },
...
static Key keys[] = {
 ...
 /* { MODKEY,             XK_p,                     spawn,          { 0 }}, */
 /* { MODKEY | ShiftMask, XK_p,                     spawn,          { 0 }}, */
 /* { MODKEY,             XK_bracketleft,           spawn,          { 0 }}, */
 /* { MODKEY | ShiftMask, XK_bracketleft,           spawn,          { 0 }}, */
 /* { MODKEY,             XK_bracketright,          spawn,          { 0 }}, */
 /* { MODKEY | ShiftMask, XK_bracketright,          spawn,          { 0 }}, */
 ...
 /* { MODKEY | ShiftMask, XK_backslash,             spawn,          { 0 } }, */
    ...
    { MODKEY | ShiftMask, XK_s,                     spawn,          SHCMD("toggle_sink")                                             },
 ...
 /* { MODKEY,             XK_apostrophe,            togglescratch,  { 0 } }, */
 /* { MODKEY | ShiftMask, XK_apostrophe,            spawn,          { 0 } }, */
 ...
 /* { MODKEY,             XK_comma,                 spawn,          { 0 } }, */
 /* { MODKEY | ShiftMask, XK_comma,                 spawn,          { 0 } }, */
 /* { MODKEY,             XK_period,                spawn,          { 0 } }, */
 /* { MODKEY | ShiftMask, XK_period,                spawn,          { 0 } }, */
 ...
 /* { MODKEY,             XK_Insert,                spawn,          { 0 } }, */
 /* { MODKEY,             XK_F1,                    spawn,          { 0 } }, */
    { MODKEY,             XK_F2,                    spawn,          SHCMD("tutorialvids")                                            },
    { MODKEY,             XK_F3,                    spawn,          SHCMD("displayselect")                                           },
    { MODKEY,             XK_F4,                    spawn,          SHCMD(TERMINAL " -e pulsemixer; kill -44 $(pidof dwmblocks)")    },
 /* { MODKEY,             XK_F5,                    xrdb,           {.v = NULL } }, */
 /* { MODKEY,             XK_F6,                    spawn,          { 0 }  }, */
 /* { MODKEY,             XK_F7,                    spawn,          { 0 }  }, */
 /* { MODKEY,             XK_F8,                    spawn,          { 0 }  }, */
    { MODKEY,             XK_F9,                    spawn,          SHCMD("dmenumount")                                              },
    { MODKEY,             XK_F10,                   spawn,          SHCMD("dmenuumount")                                             },
 /* { MODKEY,             XK_F11,                   spawn,          { 0 } }, */ 
 /* { MODKEY,             XK_F12,                   spawn,          { 0 } }, */ 
    { MODKEY,             XK_space,                 zoom,           { 0 }                                                            },
    { MODKEY | ShiftMask, XK_space,                 togglefloating, { 0 }                                                            },

    { 0,                  XK_Print,                 spawn,          SHCMD("maim pic-full-$(date '+%y%m%d-%H%M-%S').png")             },
    { ShiftMask,          XK_Print,                 spawn,          SHCMD("maimpick")                                                },
 /* { MODKEY,             XK_Delete,                 spawn,          { 0 } }, */
